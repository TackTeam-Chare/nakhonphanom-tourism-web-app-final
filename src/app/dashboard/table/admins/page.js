...
import { getAllAdmins, deleteAdmin } from '@/utils/auth/auth';
      ...
      },
      {
        ...
        Cell: ({ row }) => (
          <div className="flex space-x-2">
            <button
              onClick={() => router.push(`/dashboard/table/admins/edit/${row.original.id}`)}
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-4">
      <div className="container mx-auto bg-white p-8 rounded-lg shadow-md">
        <h1 className="text-3xl font-bold mb-8 text-center text-indigo-600">Admins</h1>
        <div className="flex justify-between items-center mb-4">
          <button
            onClick={() => router.push('/dashboard/table/admins/add')}
