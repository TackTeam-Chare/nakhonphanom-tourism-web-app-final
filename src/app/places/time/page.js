...
import { getTourismDataByOperatingHours } from '@/utils/user/api'; // Adjust the import path as needed
        ...
        {currentItems.length > 0 && (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
            {currentItems.map((entity, index) => (
              <div key={index} className="border rounded-lg overflow-hidden shadow-md hover:shadow-lg">
                <Image   width={500}height={300} src={entity.image_url} alt={entity.name} className="w-full h-48 object-cover" />
                <div className="p-4">
